...
| [`no_yapping`](templates/no_yapping/) | "…but no yapping" silent split-screen tutorial — creator fullscreen intro, then 50/50 with the demo, captions at the seam | creator video, demo video, hook text, ordered step captions, optional music |
